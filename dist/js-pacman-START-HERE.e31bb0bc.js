...
function gameLoop(pacman, ghosts) {
  ...
  checkCollision(pacman, ghosts); // Check if Pacman eats dots

  if (gameBoard.objectExist(pacman.pos, _setup.OBJECT_TYPE.DOT)) {
    playAudio(_munch.default);
    gameBoard.removeObject(pacman.pos, [_setup.OBJECT_TYPE.DOT]); // removes dots from the board
...
function startGame() {
  ...
  var ghosts = [new _Ghost.default(5, 188, _ghostMove.randomMovement, _setup.OBJECT_TYPE.BLINKY), new _Ghost.default(4, 209, _ghostMove.randomMovement, _setup.OBJECT_TYPE.PINKY), new _Ghost.default(3, 230, _ghostMove.randomMovement, _setup.OBJECT_TYPE.INKY), new _Ghost.default(2, 251, _ghostMove.randomMovement, _setup.OBJECT_TYPE.CLYDE)];
